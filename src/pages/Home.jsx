...
export default function Home() {
  return (
    <section className="py-6">
      ...
      <Section
        title={"Projects"}
        description="In my free time, I try to build things  I could use to solve personal problems and sometimes just for fun. Below are projects I have worked on for problems I face personally..."
      >
        <Projects />
      </Section>
